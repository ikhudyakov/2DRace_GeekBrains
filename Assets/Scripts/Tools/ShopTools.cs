...
namespace Tools
{
    public class ShopTools : IShop, IStoreListener
    {
        ...
        private readonly SubscriptionProperty<string> _onSuccessPurchase;
        private readonly SubscriptionAction _onFailedPurchase;

        public ShopTools(List<ShopProduct> products)
        {
            _onSuccessPurchase = new SubscriptionProperty<string>();
        ...
        public IReadOnlySubscriptionProperty<string> OnSuccessPurchase => _onSuccessPurchase;
